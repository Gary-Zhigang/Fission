...
public class Train {
    ...
    public static void train(){
        ...
        scenario.setPlatFormUser(200);
        scenario.setSeededPlayer(50);
        scenario.setPsychDistBar(0.5);
        scenario.setMaxDays(7);
        scenario.setRoundsPerDay(10);
        scenario.setMaxHelpFissionPeople(5);
